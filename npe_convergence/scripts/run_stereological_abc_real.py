...
def run_stereological_npe():
    ...
    plt.savefig('num_inclusions_posterior_stereo_abc_real.pdf')
    plt.clf()

    plt.hist(ppc_summaries[:, 1], bins=50)
    plt.axvline(y_obs_original[1], color='red')
    plt.savefig('min_inclusions_posterior_stereo_abc_real.pdf')
    plt.clf()

    plt.hist(ppc_summaries[:, 2], bins=50)
    plt.axvline(y_obs_original[2], color='red')
    plt.savefig('mean_inclusions_posterior_stereo_abc_real.pdf')
    plt.clf()

    plt.hist(ppc_summaries[:, 3], bins=50)
    plt.axvline(y_obs_original[3], color='red')
    plt.savefig('max_inclusions_posterior_stereo_abc_real.pdf')
    plt.clf()
