...
export MANIFEST_CSV="${MANIFEST_CSV:-${OUT_ROOT}/manifests/phase1_gaussian_manifest.csv}"
export MPLCONFIGDIR="$PBS_O_WORKDIR/${OUT_ROOT}/mplconfig/phase1_${PBS_ARRAY_INDEX}"
...
cell_dir="${OUT_ROOT}/gnk_gaussian_robust_n1000/cells/gaussian_npe_n_obs_${n_obs}_n_sims_${n_sims}_seed_${seed}_transform_${transform}"
