...
: "${MANIFEST_CSV:?Set MANIFEST_CSV to the prepared reference manifest CSV.}"
export OUTPUT_ROOT="${OUTPUT_ROOT:-res/overnight_20260601/dim_scaling/ma2_n1000}"
export MPLCONFIGDIR="$PBS_O_WORKDIR/$OUTPUT_ROOT/mplconfig/reference_${PBS_ARRAY_INDEX}"
